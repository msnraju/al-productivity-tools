  ...
  static readObject(context: IReadContext): IObjectContext {
    ...
    while (value !== '}') {
      switch (value) {
        ...
        case 'internal':
        case 'procedure':
          appObject.procedures.push(FunctionReader.readFunction(context));
          break;
        case 'trigger':
          appObject.triggers.push(FunctionReader.readFunction(context));
          break;
        // Table
        case 'fields':
        ...
        default:
          if (context.tokens[context.pos].type === 'comment') {
            appObject.properties.push(context.tokens[context.pos].value);
            context.pos++;
